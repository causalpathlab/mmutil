...
mu.r0 = .fread(r.hdr %&% ".resid_internal_mu.gz") %>% as.matrix
se.r0 = .fread(r.hdr %&% ".resid_internal_mu_sd.gz") %>% as.matrix
...
plot(mu.r[g, o], col=3, pch=19, log="y", main = g %in% causal.genes)
abline(h = 1, col = 2)
points(mu.r0[g, o], col=4, pch="+")

plot(mu.r[g, o], col=3, pch=19, main = g %in% causal.genes)
abline(h = 1, col = 2)
points(mu.r0[g, o], col=4, pch="+")

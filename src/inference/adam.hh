...
void
reset_adam(adam_t<Scalar, Scalar, Index>& adam, const Scalar r_m, const Scalar r_v, const Index n1,
           const Index n2) {
  adam.G = 0;
  adam.M = 0;
  adam.V = 0;
...
void
reset_adam(adam_t<Mat, Scalar, Index>& adam, const Scalar r_m, const Scalar r_v, const Index n1,
           const Index n2) {
  adam.G.resize(n1, n2);
  adam.M.resize(n1, n2);
  adam.V.resize(n1, n2);

...
struct param_col_spike_slab_t {
    ...
    explicit param_col_spike_slab_t(const index_t n1, const index_t n2,
                                    const Opt &opt)
        : nrow(n1)
        , ncol(n2)
        , onesN1(1, n1)
...
auto
make_sparse_col_spike_slab(const Eigen::SparseMatrixBase<Derived> &A,
                           const Opt &opt)
{
...
hyperparam_impl_eval_sgd(Parameter &P, const M1 &G1, const M2 &G2,
                         const M3 &Nobs, const param_tag_col_spike_slab)
{

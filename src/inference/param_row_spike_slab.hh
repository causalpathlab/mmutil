...
auto
make_sparse_row_spike_slab(const Eigen::SparseMatrixBase<Derived> &A,
                           const Opt &opt)
{
                      ...
                      const param_tag_row_spike_slab)
{
    ...
    P.alpha_aux_row +=
        update_adam(P.adam_alpha_aux_row, P.grad_alpha_aux_row) * rate;
    P.gamma_aux_row +=
        update_adam(P.adam_gamma_aux_row, P.grad_gamma_aux_row) * rate;

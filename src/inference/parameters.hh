...
param_safe_eval_sgd(Parameter& P, const Eigen::MatrixBase<Deriv1>& G1,  //
  ...
  param_impl_eval_sgd(P, G1.derived(), G2.derived(), Nobs.derived(), sgd_tag<Parameter>());
}

template <typename Parameter, typename Deriv1, typename Deriv2, typename Deriv3>
void
param_safe_eval_sgd(Parameter& P, const Eigen::SparseMatrixBase<Deriv1>& G1,  //
...
template <typename Parameter, typename Deriv1, typename Deriv2, typename Deriv3>
void
hyperparam_safe_eval_sgd(Parameter& P, const Eigen::MatrixBase<Deriv1>& G1,  //
                         const Eigen::MatrixBase<Deriv2>& G2,                //
                         const Eigen::MatrixBase<Deriv3>& Nobs, const param_tag_dense) {
  hyperparam_impl_eval_sgd(P, G1.derived(), G2.derived(), Nobs.derived(), sgd_tag<Parameter>());
}

template <typename Parameter, typename Deriv1, typename Deriv2, typename Deriv3>
void
hyperparam_safe_eval_sgd(Parameter& P, const Eigen::SparseMatrixBase<Deriv1>& G1,  //
                         const Eigen::SparseMatrixBase<Deriv2>& G2,                //
                         const Eigen::SparseMatrixBase<Deriv3>& Nobs,              //
                         const param_tag_sparse) {
  hyperparam_impl_eval_sgd(P, G1.derived(), G2.derived(), Nobs.derived(), sgd_tag<Parameter>());

...
read_network_data(const std::string data_file, const std::string color_file, const bool,
                  const double);
...
void
prune_uninformative_edges(const Graph& gIn, Graph& gOut, const Scalar);
...
int
construct_incidence_matrices(const Eigen::SparseMatrixBase<Derived>& A,
